    ...
    <div class="container">
        <div class="menu-content">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><img src="/public/images/icon.png" alt=""></a>
            </div>
...
<footer class="footer-widget-section">
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        ...
                        <div>
                            <a href="#" class="text-uppercase">Castle</a>
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2017 <a href="#">YBlog PRO, </a> Built with <i
                                class="fa fa-heart"></i> by <a href="#">Yury</a>
                    </div>
                </div>
            </div>
        </div>
